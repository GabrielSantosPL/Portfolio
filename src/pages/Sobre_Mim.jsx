...
export default function Sobre_Mim(){
    ...
    const sobre_mim = [{id: 1, title: "Sobre Mim", text: `Me chamo Gabriel Santos Patrício, tenho ${idade} anos de idade. Possuo uma irmã mais nova e dois cachorros da raça Yorkshire. Curso Desenvolvimento de Software Multiplataforma, e ocasionalmente participo de outros cursos complementares. No meu tempo livre, gosto de jogar videogames, de diferentes gêneros. Tenho como meta desenvolver minhas habilidades na área de TI para produzir minhas próprias aplicações, assim como jogos.`}]

    return(

        <Card_Image data={sobre_mim} imageWindowStyle={{width: "100px"}}/>
